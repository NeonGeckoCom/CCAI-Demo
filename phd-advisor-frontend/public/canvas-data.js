...
window.ADVISORS = [
  ...
  { id: "motivator",     name: "Motivational Coach", role: "Academic Resilience Specialist",  summary: "Energizing & confidence-building", color: "#EF4444", bg: "#FEF2F2", icon: "Zap" },
  { id: "storyteller",   name: "Narrative Advisor",  role: "Communication & Storytelling Expert", summary: "Creative & communication-focused", color: "#6366F1", bg: "#EEF2FF", icon: "Feather" },
  { id: "critic",        name: "Constructive Critic", role: "Academic Quality Analyst",       summary: "Detail-oriented & standards-focused", color: "#DC2626", bg: "#FEF2F2", icon: "Search" },
  { id: "visionary",     name: "Visionary Strategist", role: "Innovation & Future Trends Expert", summary: "Forward-thinking & innovation-focused", color: "#06B6D4", bg: "#ECFEFF", icon: "Eye" }
];
...
window.WIDGET_CATALOG = [
  ...
  { type: "pomodoro",       name: "Focus Timer",         icon: "Timer",        cat: "project",  desc: "Real timer with break cycle + session counter" },
  ...
  { type: "phd-journey",    name: "PhD Journey",         icon: "Flag",         cat: "project",  desc: "Your milestones — courses → defense → submission" },
...
// ============================================================================
// SKILL LIBRARY — specialized assistants ("skills") for specific tasks.
// Each skill is tuned to a task and can output into Workspace, Documents, or Chat.
// Built with Chen's skills system. `runnable` skills perform a real action.
// ============================================================================
window.SKILL_CATEGORIES = [
  { id: "all", label: "All skills", icon: "Sparkles" },
  { id: "research", label: "Research", icon: "BookOpen" },
  { id: "methods", label: "Methods & Stats", icon: "FlaskConical" },
  { id: "writing", label: "Writing", icon: "PenTool" },
  { id: "admin", label: "Planning & Admin", icon: "ClipboardList" },
  { id: "critic", label: "Anti-yes-man", icon: "Gavel" },
  { id: "wellbeing", label: "Wellbeing", icon: "Heart" }
];

window.SKILL_LIBRARY = [
  // research
  { id: "lit-gap", name: "Literature Gap Finder", icon: "BookOpen", cat: "research", model: "Scholar-LLM", output: "workspace",
    desc: "Scans your area and proposes the specific gap your work can fill, then seeds a reading plan.", runnable: true, featured: true },
  { id: "paper-tldr", name: "Paper Summarizer", icon: "Microscope", cat: "research", model: "Reader-LLM", output: "chat",
    desc: "Drop a PDF or DOI and get claim / method / limitations / how-it-helps-you in seconds." },
  { id: "author-map", name: "Top-Author Mapper", icon: "Award", cat: "research", model: "Scholar-LLM", output: "chat",
    desc: "Maps the most-cited researchers and venues in your space so you know who to read and cite." },
  // methods & stats
  { id: "methods-critic", name: "Methods Critic", icon: "FlaskConical", cat: "methods", model: "Methodologist-LLM", output: "chat",
    desc: "Pressure-tests your design for confounds, validity threats, and defensibility before your committee does.", featured: true },
  { id: "stats-helper", name: "Stats Advisor", icon: "Sigma", cat: "methods", model: "Stat-LLM", output: "chat",
    desc: "Recommends tests, checks assumptions, and explains the result in plain language." },
  { id: "power-calc", name: "Sample & Power", icon: "Calculator", cat: "methods", model: "Stat-LLM", output: "chat",
    desc: "Estimates the sample size you need for the effect you expect, with the reasoning shown." },
  // writing
  { id: "outline", name: "Chapter Outliner", icon: "List", cat: "writing", model: "Writer-LLM", output: "documents",
    desc: "Scaffolds a dissertation chapter so a blank page is never the blocker.", runnable: true, featured: true },
  { id: "polish", name: "Prose Polisher", icon: "PenTool", cat: "writing", model: "Editor-LLM", output: "chat",
    desc: "Tightens academic prose for clarity and flow without changing your meaning." },
  { id: "citation", name: "Citation Formatter", icon: "Quote", cat: "writing", model: "Cite-LLM", output: "workspace",
    desc: "Resolves DOIs and formats clean APA/MLA/Chicago entries into your bibliography.", runnable: true },
  // planning & admin
  { id: "todo", name: "Task Planner", icon: "ListChecks", cat: "admin", model: "Planner-LLM", output: "workspace",
  ...
  // critic
  { id: "reviewer2", name: "Reviewer 2", icon: "Gavel", cat: "critic", model: "Critic-LLM", output: "workspace",
    desc: "The harsh-but-fair peer reviewer. Adds a critique widget that pushes back on your draft.", runnable: true },
  { id: "devils", name: "Devil's Advocate", icon: "Scale", cat: "critic", model: "Critic-LLM", output: "chat",
    desc: "Builds the strongest counter-argument to your hypothesis so you can answer it first." },
  { id: "scope", name: "Scope Realism", icon: "Crosshair", cat: "critic", model: "Critic-LLM", output: "chat",
    desc: "A blunt feasibility verdict on your plan given your real timeline." },
  // wellbeing
  { id: "wellbeing", name: "Wellbeing Check", icon: "Heart", cat: "wellbeing", model: "Support-LLM", output: "chat",
    desc: "A supportive check-in for the hard weeks — names what's heavy and one small next step." },
  { id: "focus", name: "Focus Coach", icon: "Timer", cat: "wellbeing", model: "Support-LLM", output: "chat",
    desc: "Helps you protect deep-work time and beat the doom-scroll between sessions." }
];
